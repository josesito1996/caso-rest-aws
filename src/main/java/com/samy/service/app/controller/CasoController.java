...
public class CasoController {
	...
	public List<ActuacionResponseX3> listarActuacionesPorIdCasoConParametros(@PathVariable String idCaso,
			@RequestBody @Valid ListActuacionesRequestFilter params) {
		log.info("ActuacionController.verActuacionesPorIdCaso");
	...
	public UpdateTareaResponse findDetailTareaById(@RequestParam(name = "id_case") String idCase,
			@RequestParam(name = "id_actuacion") String idActuacion, @RequestParam(name = "id_tarea") String idTarea) {
	...
	public SaveTareaResponse viewTareaDetail(@ParameterObject @RequestParam(name = "id_caso") String idCaso,
