...
public class CasoController {
  ...
  /**
   * @GetMapping(path = "/listActuacionesByIdCaso/{idCaso}") public List<MainActuacionResponse>
   *                  listarActuacionesPorIdCaso(@PathVariable String idCaso) { return
   *                  service.listarActuacionesPorCaso(idCaso); }
   **/
  ...
  @Operation(
      description = "Lista las actuaciones relacionadas a un caso en especifico y ademas las puedes filtrar por parametros")
  ...
  @Operation(
      description = "Elimina una tarea de la BD, mediante un request que contiene los Id's necesarios")
  ...
  @Operation(
      description = "Lista la cantidad de casos completados por actuaciones, documentos y tareas")
  ...
  @DeleteMapping(path = "/deleteCase/{idCaso}")
  public void eliminarCaso(@PathVariable String idCaso) {
    service.eliminarCaso(idCaso);
  }

  @DeleteMapping(path = "/deleteAction")
  public void eliminarActuacion(@RequestParam String idCaso, @RequestParam String idActuacion) {
    service.eliminarActuacion(idCaso, idActuacion);
  }
